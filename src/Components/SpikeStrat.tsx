...
const SpikeStrat = (props: any) => {
  ...
  return (
    <>
      ...
      <Draggable onDrag={() => handleDrag("shirt1")} onStop={handleStop}>
        <img
          id="shirt1"
          src={tshirt}
      ...
      <Draggable onDrag={() => handleDrag("shirt2")} onStop={handleStop}>
        <img
          id="shirt2"
          src={tshirt}
          style={{ width: 50 * size, position: "absolute" }}
      ...
      <Draggable onDrag={() => handleDrag("shirt3")} onStop={handleStop}>
        <img
          id="shirt3"
          src={tshirt2}
          style={{ width: 50 * size, position: "absolute" }}
      ...
      <Draggable onDrag={() => handleDrag("shirt4")} onStop={handleStop}>
        <img
          id="shirt4"
          src={tshirt2}
          style={{ width: 50 * size, position: "absolute" }}
      ...
      <Draggable onDrag={() => handleDrag("ball")} onStop={handleStop}>
        <img
          id="ball"
          src={spikeball}
